describe("t.is", function()
  ...
  it("mtequal", function()
    ...
    assert.mtequal(t.set, t.set:of(tonumber), {'__item'})
    assert.ofset(t.set:of(tonumber))
    assert.ofset(t.set:of(tonumber))

    assert.mtequal(t.array, t.array:of(tonumber), {'__item'})
    assert.ofarray(t.array:of(tostring))
    assert.ofarray(t.array:of(tostring))
  end)
  it("bulk", function()
    assert.not_is_bulk()
  ...
  it("tonumber", function()
      assert.is_true(is.tonumber(meta.cache.loader))
  end)
end)
