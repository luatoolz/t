describe("rex", function()
  ...
  it("new", function()
    ...
    assert.is_table(rex.match)
    assert.equal(rex.match.mtname, rex.mtname.match)
  ...
  it('gsuber', function()
    assert.equal('__CALL', rex.mtname.gsuber(string.upper)('__call'))
    assert.equal('o', rex.mtname.gsuber('o')('__index'))
    assert.equal('true __b qwerty __d', rex.mtname.gsuber({__a='true',__b=false,__c='qwerty'})('__a __b __c __d'))
    assert.equal('true false __c __d', rex.mtname.gsuber({__a='true',__b='false',__c='qwerty'}, 2)('__a __b __c __d'))
  end)
  it('count', function()
